...
namespace Trading {
  ...
  #endif
  {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      pendingNotification_.WriteTo(ref output, _repeated_pendingNotification_codec);
      if (Cancelled != false) {
        output.WriteRawTag(24);
        output.WriteBool(Cancelled);
      }
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      switch(tag) {
          ...
          case 18: {
            pendingNotification_.AddEntriesFrom(ref input, _repeated_pendingNotification_codec);
            break;
          }
          case 24: {
            Cancelled = input.ReadBool();
