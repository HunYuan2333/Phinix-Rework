...
namespace Trading {
  ...
  #endif
  {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      activeTrades_.WriteTo(ref output, _repeated_activeTrades_codec);
      completedTrades_.WriteTo(ref output, _repeated_completedTrades_codec);
      if (_unknownFields != null) {
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      switch(tag) {
          default:
            ...
            break;
          case 10: {
            activeTrades_.AddEntriesFrom(ref input, _repeated_activeTrades_codec);
            break;
          }
          case 18: {
            completedTrades_.AddEntriesFrom(ref input, _repeated_completedTrades_codec);
            break;
          }
        }
      }
