...
namespace Trading {
  ...
  #endif
  {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      itemsOnOffer_.WriteTo(ref output, _map_itemsOnOffer_codec);
      acceptedParties_.WriteTo(ref output, _repeated_acceptedParties_codec);
      if (_unknownFields != null) {
    ...
    public void MergeFrom(TradeStore other) {
      ...
      itemsOnOffer_.MergeFrom(other.itemsOnOffer_);
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      switch(tag) {
          ...
          case 26: {
            itemsOnOffer_.AddEntriesFrom(ref input, _map_itemsOnOffer_codec);
            break;
          }
          case 34: {
            acceptedParties_.AddEntriesFrom(ref input, _repeated_acceptedParties_codec);
            break;
          }
        }
      }
